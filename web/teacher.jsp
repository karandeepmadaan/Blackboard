<%-- 
    Document   : teacher
    Created on : Jul 8, 2014, 11:02:55 PM
    Author     : Saurabh Garg
--%>
        ...
        <div id="main-wrapper" >
            ...
            <div style=" padding:20px 50px;border-radius: 10px; float: left;   height:780px ;width:30%;margin-left: 3%;">
                ...
                <form  action="Add_assign.jsp"><%
                    ...
                    <input class="button" value="Add Assignments" type="submit" style="padding:5px;">
                </form>
                <br>
                <center>
                    <span >
                    ...
                    <center>
                        ...
                        <div style=" border-radius: 10px; float: left;  height:800px ;width:30%;margin-left: 20px">
                            <div style=" padding:20px;border-radius: 10px;    height:50% ;width:100%">
                                ...
                                <span style="text-align: right">    <a href="announce_1.jsp">    <input type="button" style="padding:5px;" class="button" value="Read More"></a></span>
                            </div><br><br>
                        ...
                        <div style="padding:20px; border-radius: 10px; float: left;   height:780px ;width:30%;margin-left: 20px;">
                            ...
                            <%  Statement smt1 = con.createStatement();
                                ...
                                }%><span style="text-align: right">    <a href="newdiscussiont?subject=<%out.print(rs1.getString(1));%>">    <input type="button" style="padding:5px;" class="button" value="Read More"></a></span><br><br><%
                                    }%>    
                        </div>
                        </div>
                </body>
