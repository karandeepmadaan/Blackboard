...
<html>
    ...
    <body>
        ...
        <div id="main-wrapper">
            ...
            <div style=" padding:50px;border-radius: 10px; float: left;   height:780px ;width:30%;margin-left: 3%">
                <center>
                    <span >
                ...
                <center>
                    ...
                    <center>
                        ...
                        <div style=" border-radius: 10px; float: left;  height:800px ;width:30%;margin-left: 20px">
                            <div style=" padding:20px;border-radius: 10px;    height:50% ;width:100%">
                                <center>
                                    <span >
                                ...
                                <%
                                    ...
                                    rs = smt.executeQuery("select * from announcement  order by created desc limit 1,3");
                                    while (rs.next()) {
                                ...
                                <span style="text-align: right">    <a href="add_announce.jsp">    <input type="button" style="padding:5px;" class="button" value="Read More"></a></span>
                            </div><br><br>
                            <div style=" padding:20px;border-radius: 10px;    height:50% ;width:100%"></div>
                        </div>
                        <div style="padding:20px; border-radius: 10px; float: left;   height:780px ;width:30%;margin-left: 20px">
                            ...
                            <%  Statement smt1 = con.createStatement();
                                ...
                                rs2 = smt2.executeQuery("select * from discussion where course_course_id='" + rs1.getString(1) + "'order by created desc limit 0,2;");
                                while (rs2.next()) {
                                ...
                                }%><br><span style="text-align: right">    <a href="discussion?subject=<%out.print(rs1.getString(1));%>">    <input type="button" style="padding:5px;" class="button" value="Read More"></a></span><br><%
                        }%>    
                        </div>
